    ...
    <div className="flex items-center justify-between px-1 shrink-0 font-sans">
      {isEditing ? (
        <Input
          ...
          className="text-sm font-semibold h-8 w-44 focus-visible:ring-primary font-sans"
          disabled={loading}
          autoFocus
        />
      ) : (
        <div className="flex items-center gap-2">
          <span
            ...
            className="font-semibold text-gray-700 text-sm cursor-pointer hover:text-black"
          >
            {name}
          </span>
