  ...
  return (
    <div className="flex h-full w-full flex-col gap-6 font-sans animate-pulse">
      <div className="grid shrink-0 grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="space-y-2 rounded-xl border border-gray-200 bg-white p-4 shadow-xs">
          <div className="h-3 w-10 rounded bg-gray-200" />
          <div className="h-7 w-8 rounded bg-gray-300" />
        </div>
        <div className="space-y-2 rounded-xl border border-gray-200 bg-white p-4 shadow-xs">
        ...
        <div className="space-y-2 rounded-xl border border-gray-200 bg-white p-4 shadow-xs">
          ...
          <div className="h-7 w-8 rounded bg-red-100" />
        </div>
        <div className="space-y-2 rounded-xl border border-gray-200 bg-white p-4 shadow-xs">
      ...
      <div className="min-h-0 flex-1 rounded-xl border border-gray-200 bg-white p-5 shadow-xs sm:p-6">
